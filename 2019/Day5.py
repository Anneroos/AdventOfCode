...
print("Output day 5 puzle 1: ")
runCode(puzzleinput.copy(),1)

print("-----***---------*******---------------**---------******---------------")
print("Output day 5 puzle 2: ")
runCode(puzzleinput.copy(),5)
